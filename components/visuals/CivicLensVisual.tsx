  ...
  return (
    ...
    >
      ...
      <g className={styles.archiveSource}>
        <rect height="196" width="124" x="24" y="78" />
        ...
        {[0, 1, 2, 3].map((index) => (
          <g className={styles.databaseRow} key={index}>
            <rect height="22" width="92" x="40" y={134 + index * 28} />
      ...
      <g className={styles.archiveExporter}>
        <rect height="196" width="124" x="180" y="78" />
      ...
      <g className={styles.archiveStorage}>
        <rect height="196" width="124" x="336" y="78" />
      ...
      <g className={styles.archiveDashboard}>
        <rect height="196" width="124" x="492" y="78" />
        ...
        <rect height="94" width="92" x="508" y="136" />
  ...
  return (
    <>
      ...
      {archiveStages.map((stage, index) => {
        ...
        return (
          <g className={stateClass} key={stage.label}>
            ...
            <rect height="60" width="250" x="60" y={y} />
      ...
      <g className={styles.compactArchiveResult}>
        <rect height="48" width="300" x="20" y="400" />
