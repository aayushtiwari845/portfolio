  ...
  return (
    ...
    >
      ...
      <g className={styles.stageBox}>
        <rect height="76" width="72" x="24" y="142" />
      ...
      <g className={styles.stageBox}>
        <rect height="60" width="70" x="112" y="150" />
      ...
      <g className={styles.stageBox}>
        <rect height="60" width="78" x="198" y="150" />
        ...
        {agents.map((agent, index) => {
          ...
          return (
            <g className={styles.agent} key={agent}>
              ...
              <rect height="42" width="112" x="316" y={centerY - 21} />
      ...
      <g className={styles.decisionBox}>
        <rect height="52" width="146" x="470" y="76" />
      ...
      <g className={styles.stageBox}>
        <rect height="52" width="146" x="470" y="154" />
      ...
      <g className={styles.outputBox}>
        <rect height="52" width="146" x="470" y="232" />
  ...
  return (
    <>
      ...
      <g className={styles.compactStage}>
        <rect height="36" width="280" x="30" y="40" />
      ...
      <g className={styles.compactStage}>
        <rect height="36" width="280" x="30" y="88" />
      ...
      <g className={styles.compactStage}>
        <rect height="36" width="280" x="30" y="136" />
      ...
      <g className={styles.compactAgentGroup}>
        <rect height="128" width="280" x="30" y="184" />
        <text className={styles.compactGroupLabel} x="48" y="201">FOUR-WAY FAN-OUT / FAN-IN</text>
        <path className={styles.compactConnector} d="M170 172V188H40V296M40 218H70M40 244H70M40 270H70M40 296H70M270 218H292M270 244H292M270 270H292M270 296H292M292 218V312H170V326" />
        {agents.map((agent, index) => {
          const y = 208 + index * 26;
          return (
            <g className={styles.compactAgent} key={agent}>
              <rect height="20" width="200" x="70" y={y} />
      ...
      <path className={styles.compactSignal} d="M170 76V88M170 124V136M170 172V188H40V296M40 218H70M40 244H70M40 270H70M40 296H70M270 218H292M270 244H292M270 270H292M270 296H292M292 218V312H170V326" />

      <g className={styles.compactDecision}>
        <rect height="36" width="280" x="30" y="326" />
      ...
      <g className={styles.compactStage}>
        <rect height="36" width="280" x="30" y="374" />
      ...
      <g className={styles.compactOutput}>
        <rect height="36" width="280" x="30" y="422" />
