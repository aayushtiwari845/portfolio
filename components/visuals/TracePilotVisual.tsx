  ...
  return (
    ...
    >
      ...
      <g className={styles.servicePanel}>
        <rect height="196" width="116" x="24" y="76" />
      ...
      <g className={styles.decisionBox}>
        <rect height="70" width="88" x="162" y="107" />
      ...
      <g className={styles.evidencePanel}>
        <rect height="224" width="174" x="276" y="66" />
        ...
        {evidenceRows.map((label, index) => {
          ...
          return (
            <g className={styles.evidenceRow} key={label}>
              <rect height="22" width="104" x="292" y={y - 14} />
        ...
        <g className={styles.correlationCell}>
          <rect height="42" width="142" x="292" y="220" />
      ...
      <g className={styles.rankingBox}>
        <rect height="72" width="142" x="474" y="98" />
      ...
      <g className={styles.outputBox}>
        <rect height="76" width="142" x="474" y="214" />
  ...
  return (
    <>
      ...
      <g className={styles.compactServiceGraph}>
        <rect height="54" width="300" x="20" y="40" />
      ...
      <g className={styles.compactDecision}>
        <rect height="42" width="300" x="20" y="108" />
      ...
      <g className={styles.compactEvidence}>
        <rect height="142" width="300" x="20" y="166" />
        ...
        {evidenceRows.map((label, index) => {
          ...
          return (
            <g className={styles.compactEvidenceItem} key={label}>
              <rect height="30" width="126" x={x} y={y} />
              <circle cx={x + 14} cy={y + 15} r="3" />
              <text x={x + 27} y={y + 20}>{label}</text>
            </g>
          );
        })}
        <path className={styles.compactConnector} d="M101 234V239H29V285M239 234V239H311V285M101 274V285M239 274V285M29 285H311M170 285V308" />
      </g>
      <path className={styles.compactSignal} d="M170 94V108M170 150V166M101 234V239H29V285M239 234V239H311V285M101 274V285M239 274V285M29 285H311M170 285V322" />

      <g className={styles.compactDecision}>
        <rect height="46" width="300" x="20" y="322" />
      ...
      <g className={styles.compactOutput}>
        <rect height="56" width="300" x="20" y="382" />
