  ...
  return (
    <div
      ...
      aria-label={
        decorative
          ? undefined
          : "A connected topology joining systems, data and intelligence."
      }
      className={clsx(
        styles.fallback,
    ...
    >
      ...
      >
        ...
        <g className={styles.regionLabel} transform="translate(54 455)">
          <text>REGION / 01</text>
          <text className={styles.regionName} y="20">
            SYSTEMS
          </text>
          <path d="M0 30H77" />
        </g>
        ...
        <g className={styles.telemetryLabel} transform="translate(479 77)">
          <rect height="27" rx="4" width="145" />
          <circle cx="13" cy="13.5" r="3" />
          <text x="24" y="17">
            SIGNAL / NOMINAL
          </text>
        </g>
        <text className={styles.coordinateLabel} x="42" y="35">
          TOPOLOGY / 00-A
        </text>
        <text className={styles.coordinateLabel} x="658" y="528" textAnchor="end">
          19 NODES / 28 LINKS
        </text>
      </svg>
    </div>
